...
```sh
# starts the application in development mode - app is accessible at http://localhost:3001 by default, and it includes a pre-configured user with the username "admin" and password "admin"
$ npm run start
```
