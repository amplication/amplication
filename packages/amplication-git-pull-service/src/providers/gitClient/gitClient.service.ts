...
import { ICloneParams, IGitClient, IPullParams } from "../../contracts/gitClient.interface";
...
export class GitClientService implements IGitClient {
  ...
  clone(cloneParams: ICloneParams, baseDir: string, accessToken: string): void {
    ...
    this.git.clone(`https://${owner}:${accessToken}@github.com/${owner}/${repository}`, baseDir);
  }
