...
| -------------------- | -------------------------------------- | --------------------- |
| PORT                 | the port that the client is running on | 3001                  |
| REACT_APP_SERVER_URL | connection url to the server           | http://localhost:3000 |
...
build the docker image for the admin-ui
