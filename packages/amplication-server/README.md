...
| KAFKA_CLIENT_ID | asdf  | `server-queue-client` |
| KAFKA_GROUP_ID | The consumer group name  | "main-server-group" |
| GENERATE_PULL_REQUEST_TOPIC | kafka topic for git pull request  | "git.pr.generate.message" |
...
| GITHUB_APP_CLIENT_SECRET|  i don't know  |[use-secret-manager] |
| GITHUB_APP_CLIENT_ID|  i don't know  |[github-app-client-id] |
| GITHUB_APP_APP_ID| i don't know  |[github-app-app-id]|
| GITHUB_APP_PRIVATE_KEY|  i don't know  |[github-app-private-key] |
| GITHUB_APP_INSTALLATION_URL| i don't know  |[github-app-installation-url] |
