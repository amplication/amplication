...
import {
  ...
  GCP_TERRAFORM_APP_ID_VARIABLE,
  GCP_TERRAFORM_IMAGE_ID_VARIABLE,
  ...
  test('deploys correctly', async () => {
    ...
    expect(deployerServiceDeploy).toBeCalledWith(
      gcpDeployConfiguration,
      {
        ...
        [GCP_TERRAFORM_APP_ID_VARIABLE]: EXAMPLE_APP_ID,
        [GCP_TERRAFORM_IMAGE_ID_VARIABLE]: EXAMPLE_IMAGE_ID,
