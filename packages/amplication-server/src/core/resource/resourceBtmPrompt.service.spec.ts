...
describe("ResourceBtmPromptService", () => {
  let service: ResourceBtmPromptService;

  beforeAll(async () => {
    const module = await Test.createTestingModule({
      providers: [ResourceBtmPromptService],
    }).compile();
    service = module.get<ResourceBtmPromptService>(ResourceBtmPromptService);
  });
