...
export const ID_DEFAULT_VALUE_CUID_FUNCTION_VALUE = "cuid()";
export const ID_DEFAULT_VALUE_UUID_FUNCTION_VALUE = "uuid()";
export const ID_DEFAULT_VALUE_AUTO_INCREMENT_FUNCTION_VALUE = "autoincrement()";
...
export const prismaIdTypeToDefaultIdType = {
  [PRISMA_TYPE_INT]: ID_DEFAULT_VALUE_AUTO_INCREMENT_FUNCTION_VALUE,
  [PRISMA_TYPE_STRING]: ID_DEFAULT_VALUE_CUID_FUNCTION_VALUE,
  [PRISMA_TYPE_BIG_INT]: ID_DEFAULT_VALUE_AUTO_INCREMENT_FUNCTION_VALUE,
};
