...
export class ServiceSettingsService {
  ...
  private updateServiceGenerationSettings(
    ...
    settings.adminUISettings.generateAdminUI =
      generationSettings.generateAdminUI;
    settings.serverSettings.generateGraphQL =
      generationSettings.generateGraphQL;
    settings.serverSettings.generateRestApi =
      generationSettings.generateRestApi;
  }
}
