...
const USER: CopiedEntities = {
  id: USER_ID,
  name: USER_ENTITY_NAME,
  versions: [{ ...EXAMPLE_VERSION, id: "userEntityVersionId" }],
  displayName: "User",
...
const PROFILE: CopiedEntities = {
  id: PROFILE_ENTITY_ID,
  name: "Profile",
  versions: [{ ...EXAMPLE_VERSION, id: "profileEntityVersionId" }],
  displayName: "Profile",
...
const ORDER: CopiedEntities = {
  id: "dc63b5ef-e386-4a1c-b764-8926dd3066b8",
  name: "Order",
  versions: [{ ...EXAMPLE_VERSION, id: "orderEntityVersionId" }],
...
const ORGANIZATION: CopiedEntities = {
  id: ORGANIZATION_ID,
  name: "Organization",
  versions: [{ ...EXAMPLE_VERSION, id: "organizationEntityVersionId" }],
...
const CUSTOMER: CopiedEntities = {
  id: CUSTOMER_ENTITY_ID,
  name: "Customer",
  versions: [{ ...EXAMPLE_VERSION, id: "customerEntityVersionId" }],
...
const EMPTY: CopiedEntities = {
  id: "0c5ad4df-0467-444a-a249-94c2465ae90d",
  name: "Empty",
  displayName: "Empty",
  versions: [{ ...EXAMPLE_VERSION, id: "emptyEntityVersionId" }],
...
const entitiesToCopy: CopiedEntities[] = [
  USER,
  PROFILE,
  ORDER,
  ORGANIZATION,
