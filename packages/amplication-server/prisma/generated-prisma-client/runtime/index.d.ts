...
declare type Args_2 = ResultArgs & ModelArgs & ClientArgs & QueryOptions;
...
declare type EmptyToUnknown<T> = T extends unknown
  ? {} extends T
    ? unknown
    : T
  : never;
...
declare namespace Extensions_2 {
  export { GetResultTypes, GetResultSelect, Args_2 as Args };
}
...
declare function getExtensionContext<T>(that: T): { [K in keyof T]-?: T[K] };
...
declare type GetResultSelect<
  T extends (Args_2["result"] & {})[string],
  F extends T["fields"] = T["fields"]
> = [T] extends [never]
  ? unknown
  : {
      [K in keyof Utils.EmptyToUnknown<F>]?: true;
    };

declare type GetResultTypes<
  T extends (Args_2["result"] & {})[string],
  F extends T["fields"] = T["fields"]
> = [T] extends [never]
  ? unknown
