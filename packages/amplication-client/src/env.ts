...
export const REACT_APP_ANALYTICS_API_KEY = get(
  "NX_REACT_APP_ANALYTICS_API_KEY"
);
export const REACT_APP_ANALYTICS_API_DOMAIN = get(
  "NX_REACT_APP_ANALYTICS_API_DOMAIN"
);
export const REACT_APP_ANALYTICS_DOMAIN = get("NX_REACT_APP_ANALYTICS_DOMAIN");
...
export const NX_REACT_APP_NOVU_IDENTIFIER = get("NX_REACT_APP_NOVU_IDENTIFIER");
