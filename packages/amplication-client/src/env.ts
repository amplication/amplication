...
export const REACT_APP_STORAGE_GATEWAY_URL = get(
  "REACT_APP_STORAGE_GATEWAY_URL"
);
export const REACT_APP_DATA_SOURCE = get("REACT_APP_DATA_SOURCE");
export const REACT_APP_SERVER_URI = get("REACT_APP_SERVER_URI");
export const REACT_APP_NOVU_APP_ID_FROM_ADMIN_PANEL = get("REACT_APP_NOVU_APP_ID_FROM_ADMIN_PANEL");
