          ...
          answer={
            <>
              <p>
                ...
                subscriptions through AWS Marketplace. That's why we've made it
                possible for you to subscribe to our services directly from
                there.
              </p>
              <p>
                To view our plans and make a purchase via AWS Marketplace,
                simply{" "}
                <a
                  className="mail-link"
