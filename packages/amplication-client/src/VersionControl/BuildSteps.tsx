...
import { GIT_PROVIDER_NAME } from "../Resource/git/constants";
    ...
    <div>
      ...
      {stepGithub && (
        <Panel
          ...
          panelStyle={EnumPanelStyle.Bordered}
        >
          <Icon icon={GIT_PROVIDER_ICON_MAP[providerName]} />
          <span>{`Push Changes to ${GIT_PROVIDER_NAME[providerName]}`}</span>
