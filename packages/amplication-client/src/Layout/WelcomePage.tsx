  ...
  const openSourceMessage = (
    <div className="open-source-message">
      <p>
        ...
        production ready. Every app generated by the Amplication platform
        contains production-ready, open-source components and packages. We
        include only those that are popular, documented, secured and supported.
        Read more about our stack{" "}
        <a
