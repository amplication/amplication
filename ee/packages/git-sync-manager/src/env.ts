...
export class Env {
  ...
  static readonly PULL_PRIVATE_PLUGIN_REQUEST_TOPIC =
    "PULL_PRIVATE_PLUGIN_REQUEST_TOPIC";
  static readonly PULL_PRIVATE_PLUGIN_SUCCESS_TOPIC =
    "PULL_PRIVATE_PLUGIN_SUCCESS_TOPIC";
  static readonly PULL_PRIVATE_PLUGIN_FAILURE_TOPIC =
    "PULL_PRIVATE_PLUGIN_FAILURE_TOPIC";
