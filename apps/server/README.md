...
You can find a full list of targets in the [project.json](/Users/arielweinberger/Development/amplication/amplication/apps/server/project.json) file.
...
| COMPOSE_PROJECT_NAME | name of the docker image  |  server |
