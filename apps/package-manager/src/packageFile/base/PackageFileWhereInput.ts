...
class PackageFileWhereInput {
  ...
  fullContent?: StringNullableFilter;
  ...
  originalFileChecksum?: StringNullableFilter;
...
export { PackageFileWhereInput as PackageFileWhereInput };
