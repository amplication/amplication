...
secrets_file=os.getenv('SECRETS_FILE_PATH',os.path.join("/Users/iliagerman/Work/Sela/Clients/amplication/amplication/helm/charts/amplication/values-secrets-staging.json"))
