...
class App {
    constructor(actionProvider) {
        ...
        this.findFoldersAppName = (workingDirectory, folders) => {
            return folders
                .flatMap((folder) => {
                ...
                if (appName) {
                    ...
                    console.warn(`APP NAME NOT FOUND FOR FOLDER ${folder} SKIPPING FOLDER`);
                }
                return {
                    folder: folder,
                    name: appName,
        ...
        this.getAppName = (workingDirectory, directory) => {
            try {
                const text = (0, utils_1.readFile)(`${workingDirectory}/${directory}/package.json`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.randomString = exports.deleteFolder = exports.writeFile = exports.readFile = void 0;
const fs_1 = __nccwpck_require__(147);
...
function writeFile(path, contents) {
    console.log((0, path_1.dirname)(path));
    (0, fs_1.mkdirSync)((0, path_1.dirname)(path), { recursive: true });
    (0, fs_1.writeFileSync)(path, contents, { encoding: 'utf-8' });
}
...
const app = new app_1.App(actionProvider);
app.main();
